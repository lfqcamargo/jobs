...
def delete_question_validator(http_request: HttpRequest) -> None:
    """
    Validates the parameters in the given HTTP request for question deletion.
    ...
    class ParamData(BaseModel):
        """
        Validate Param Schema for Delete Question
        """
