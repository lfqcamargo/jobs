...
def delete_skill_validator(http_request: HttpRequest) -> None:
    """
    Validates the parameters in the given HTTP request for skill deletion.
    ...
    class ParamData(BaseModel):
        """
        Validate Param Schema for Delete Skill
        """
